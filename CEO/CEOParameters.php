    ...
    try {
        switch ($_POST['action']) {
            ...
            case 'approve_request':
                ...
                $result = $ceo->updateRequestStatus($_POST['requestId'], 'approved');
            ...
            case 'decline_request':
                ...
                $result = $ceo->updateRequestStatus($_POST['requestId'], 'declined', $_POST['comments']);
                echo $result ? 'success' : 'error';
                break;
        }
    } catch (Exception $e) {
