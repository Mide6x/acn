            ...
            <div class="card-body">
                ...
                <form id="editRequestForm" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <button type="button" id="addStation" class="btn btn-secondary mt-2" onclick="addStationRequestHOD()">
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit" class="btn btn-primary" onclick="submitRequest('<?php echo $jdrequestid; ?>')">Save Changes</button>
                    </div>
                </form>
            </div>
        </div>
